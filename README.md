...
German localization for **Old World** for **Version: 0.1.40437**. (WIP)
...
At the 5th line it says *Version* make it look like this **Version="Version: 0.1.40437+German+German Translation=-1182266509"** - make sure German is selected in the UI options (or enable it from the loaded game in the options).
...
Auf der 5 Zeile steht *Version* - bearbeite die Zeile das sie so aussieht, **Version="Version: 0.1.40437+German+German Translation=-1182266509"** - gehe sicher das Deutsch in den Optionen bei UI eingestellt ist (oder aktiviere es im Spiel selber in den Optionen).
