...
German localization for **Old World** for **Release Version (v.1.11d)**. (WIP)
...
- Right now its not planned to translated any more stories, etc.
...
- Es ist aktuell nicht geplant weitere Stories, etc. zu übersetzen
